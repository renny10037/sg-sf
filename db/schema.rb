...
ActiveRecord::Schema.define(version: 20170929031648) do
  ...
  create_table "banks", force: :cascade do |t|
    t.string   "stack_bank_id", limit: 255
    t.string   "type_account",  limit: 255
    t.string   "cod",           limit: 255
    t.string   "n_account",     limit: 255
  ...
  create_table "history_asignations", force: :cascade do |t|
    t.string   "order_id",      limit: 255
    t.string   "phase_id",      limit: 255
    t.date     "date_start"
    t.date     "date_end"
    ...
    t.string   "state_id",      limit: 255
    t.string   "admin",         limit: 255
    t.string   "asignation_id", limit: 255
    t.datetime "created_at",                  null: false
    t.datetime "updated_at",                  null: false
  end
  ...
  create_table "notifications", force: :cascade do |t|
    ...
    t.string   "asignation",       limit: 255
    t.string   "description",      limit: 255
    t.string   "state",            limit: 255
    t.string   "payment",          limit: 255
    t.string   "money",            limit: 255
    t.string   "quantify_payment", limit: 255
    t.datetime "created_at",                   null: false
    t.datetime "updated_at",                   null: false
  end
  ...
  create_table "percentage_costs", force: :cascade do |t|
    t.string   "order_id",   limit: 255
    t.float    "quantify",   limit: 24
    t.datetime "created_at",             null: false
    t.datetime "updated_at",             null: false
  ...
  create_table "stack_banks", force: :cascade do |t|
    t.string   "name",       limit: 255
    t.string   "cod",        limit: 255
    t.datetime "created_at",             null: false
    t.datetime "updated_at",             null: false
