...
class Ability
  ...
  def initialize(user)
    ...
    if user.has_role? :admin
      ...
      # - StackBank authorize -
      can :manage, StackBank

      # - PercentageCost authorize -
      can :manage, PercentageCost
      ...
      # - Payment authorize -
      can :manage, Payment
      # - Asignation authorize -
      can :manage, Asignation
      ...
      # - User authorize -
      can [:inspect,:delete, :show, :edit, :update,
           :create, :index, :destroy_multiple], User
      can :destroy, User do |u|
        !u.eql?(user)
      end

    elsif user.has_role? :empleeyer
      can :manage, Bank
